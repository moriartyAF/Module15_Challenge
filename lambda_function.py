...
def recommend_portfolio(intent_request):
    ...
    if risk_level == "none":
        ...
        recommendation == risk_level_low
    elif risk_level == "medium":
        recommendation == risk_level_med
    else:
        recommendation == risk_level_high

    return close(
        intent_request["sessionAttributes"],
        "fulfilled",
        {"contentType":"plaintext",
        "content":"""Based upon your responses, the following asset mix is suggested: {}""".format(recommendation),},)
